...
class RunSettings:
    ...
    is_skip_padding: bool = DefaultVal(False)
    is_skip_special: bool = DefaultVal(False)
    is_use_noun: bool = DefaultVal(False)
    is_use_min_threshold: bool = DefaultVal(False)
    is_use_weighted_sum: bool = DefaultVal(False)
    is_use_phrase_level: bool = DefaultVal(False)
    is_noun_important: bool = DefaultVal(False)
    noun_importance_weight: float = DefaultVal(1.5)
    is_use_importance: bool = DefaultVal(False)
    informative_scale: float = DefaultVal(1.2)
    is_freeze_emb: bool = DefaultVal(False)
...
class QuerySettings:
    ...
    attn_heads_num: int = DefaultVal(8)
...
class TrainingSettings:
    ...
    accumsteps: int = DefaultVal(8)

    lr: float = DefaultVal(5e-04)

    maxsteps: int = DefaultVal(16000)
    ...
    is_new_dataset: bool = DefaultVal(False)

    is_less_hard: bool = DefaultVal(False)

    is_peft: bool = DefaultVal(False)

    is_quantize: bool = DefaultVal(False)
