...
class CandidateGeneration:
    ...
    def get_cells(self, Q, ncells, Q_mask: Optional[torch.Tensor] = None) -> Tuple:
    ...
    def generate_candidate_pids(
        self, Q, ncells, Q_mask: Optional[torch.Tensor] = None
    ) -> Tuple:
        cells, scores = self.get_cells(Q, ncells, Q_mask)
    ...
    def generate_candidates(self, config, Q, Q_mask: Optional[torch.Tensor] = None):
        ...
        pids, centroid_scores = self.generate_candidate_pids(Q, ncells, Q_mask)
